...
#圖4.1.2.7 SGD及ASGD方法在不同學習率下的變化
matplot(g1, log(trV), type="l", xlab="learning rate",lwd=2,ylab = 'log(trace)',main='stream data')
legend('topleft',col=1:3,legend = c('SGD_theoretical','SGD','ASGD'),lty = c(1,2,2),lwd=2)
