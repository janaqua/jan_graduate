from OptimizationMethods import ASGD_gamma_decay
...
for i in tqdm(range(1000)):
    ...
    for j in [1]:  #determine the nums of epoch to use
        ...
        lr_beta = np.array([0.025,0.025,0.025,0.025,0.025])  
        ...
        model = ASGD_gamma_decay.reg(data)
        start = time.clock()
...
data1.to_csv('1000_times_beta_gamma_decay.csv',index =False)
