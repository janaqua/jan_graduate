from OptimizationMethods import ASGD_test
...
for i in tqdm(range(1000)):
    ...
    for j in [1]:  #determine the nums of epoch to use
        ...
        lr_beta = np.array([0.001,0.001,0.001,0.001,0.001])  
...
data1.to_csv('1000_times_beta_test.csv',index =False)
