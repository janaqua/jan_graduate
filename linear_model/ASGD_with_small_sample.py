from OptimizationMethods import ASGD_with_small_sample
...
for i in tqdm(range(1000)):
    ...
    for j in [1]:  #determine the nums of epoch to use
        ...
        lr_beta = np.array([0.005,0.005,0.005,0.005,0.005])  
        ...
        model = ASGD_with_small_sample.reg(data)
        start = time.clock()
...
data1.to_csv('1000_times_beta_small_sample.csv',index =False)
