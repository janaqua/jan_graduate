...
for j in tqdm([1,2,5,10,20,30,50]) :
    ...
    df.to_csv('ToConcatenate_fix_param\Batch_ASGDandSGD_with_GammaDecay_df%d.csv'%j)
    ...
    df_e.to_csv('ToConcatenate_fix_param\Batch_ASGDandSGD_with_GammaDecay_df_error%d.csv'%j)
